...
public class Exercicio1 {
	...
	// Dicas
	// == não pode usar em strings
	//! na frente negação (ex. !regiao.equals)
	// entre valores usar and (&&)
	// limitar casas decumais na saida usar printf ("valor atual: %.2f\n (\n quebra linha)
	...
	public static void main(String[] args) {
		...
		String regiao = JOptionPane.showInputDialog("Qual a sua Região").toUpperCase();
		float valorAtual=0;
	...
	if (tempo>5) {
	 	...
	 	System.out.printf("valor atualizado 2: %.2f\n", valorAtual);
	 	System.out.println("Diferença..........: " + (valorAtual - valor));
