...
// não preenchemos todos, mais há necessidade de fazer
	
	Aluno aluno = new Aluno();
// <Aluno esta no Modelo> <aluno estamos criando> <new comando criação instanciamento> <Aluno import do modelo> 
